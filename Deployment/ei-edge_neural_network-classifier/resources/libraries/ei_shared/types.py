...
ClassificationMode = Literal[
    "classification", "regression", "object-detection", "visual-anomaly", "anomaly-gmm", "freeform", "anomaly"
]
...
class CustomModelVariant(TypedDict):
    key: str

# This should match CustomVariantInferenceJobModelVariant in learn-block-keras.ts
class CustomModelVariantInfo(TypedDict):
    variant: CustomModelVariant
    outputPredictionsPath: str
    outputPredictionsFeatureExplorerPath: Optional[str]
    outputProfilingPath: Optional[str]

# This should match CreateKerasTrainModelOptions['labelMap'] in templates.ts
